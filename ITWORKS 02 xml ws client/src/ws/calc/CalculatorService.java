 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calc.ws/", wsdlLocation = "http://localhost:8080/calc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://calc.ws/", "CalculatorService");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://calc.ws/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calc.ws/", "CalculatorPort"), Calculator.class, features);
    }
